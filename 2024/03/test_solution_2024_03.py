from solution_2024_03 import find_all_instructions, sum_mul_instructions, sum_enabled_mul_instructions
...
def test_find_all_instructions_example():
    ...
    """
    memory = "xmul(2,4)&mul[3,7]!^don't()_mul(5,5)+mul(32,64]then(mul(11,8)do()?mul(8,5))"
    expected_instructions = ["mul(2,4)", "don't()", "mul(5,5)", "mul(11,8)", "do()", "mul(8,5)"]
...
def test_find_all_instructions_with_invalid_do_and_dont():
    ...
    expected_instructions = ["mul(2,2)", "do()", "mul(3,3)", "mul(4,4)", "don't()", "mul(5,5)"]
    assert find_all_instructions(memory) == expected_instructions
...
def test_find_all_instructions_with_spaces():
    ...
    expected_instructions = ["mul(9,9)", "mul(7,7)"]  # Only mul(9,9) and mul(7,7) are valid
    assert find_all_instructions(memory) == expected_instructions
